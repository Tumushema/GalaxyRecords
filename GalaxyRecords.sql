...
INSERT INTO `computers` (`cid`, `name`, `authors`, `edition`, `status`, `quantity`, `department`) VALUES
(1, 'agaba', 'V.K. Mehta, Rohit Mehta', '3rd', 'Available', 3, 'Dell'),
(2, 'The Complete Reference C++', 'Herbert Schildt', '4th', 'Available', 4, 'CSE'),
(3, 'Macbook', 'Seymour Lipschutz', '4th', 'Available', 4, 'Macbook');
...
(5, 'Promi', 'hello!'),
(16, 'Afifa', 'There are no computers of Macbook .When will it be available?'),
(17, 'Admin', 'Hi! which computer do you need Abaho. Please let us know.'),
(18, '', 'hello! '),
(19, 'Allan', 'Hi! which computer do you need Allan. Please let us know.');
...
INSERT INTO `price` (`username`, `cid`, `sold`, `day`, `amount`, `status`) VALUES
('Poly', 1, '2019-05-21', 31, 3.1, 'not paid'),
('Afifa', 1, '2019-05-21', 1, 0.1, 'not paid');

-- --------------------------------------------------------

--
-- Table structure for table `issue_computer`
--

CREATE TABLE IF NOT EXISTS `issue_computer` (
  `username` varchar(100) NOT NULL,
  `bid` int(100) NOT NULL,
