...
<!--_________________sidenav_______________-->
  ...
  <div class="h"> <a href="Customerlaptops.php">Computers</a></div>
...
<div class="container">
	...
	<h3 style="text-align: center;">Request a Computer</h3>

	<?php
	
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT customer.username,id,computers.cid,name,authors,edition,status FROM customer inner join order_computer ON customer.username=order_computer.username inner join computers ON 
		order_computer.cid=computers.cid WHERE order_computer.approve =''";
